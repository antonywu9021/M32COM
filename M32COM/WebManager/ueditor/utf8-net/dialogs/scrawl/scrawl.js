...
(function () {
    ...
    scrawl.prototype = {
        ...
        initOptions:function (options) {
            ...
            me._addBoardListener(options.saveNum);//Add画板处理
            me._addOPerateListener(options.saveNum);//Addundo redo clearBoard处理
            me._addColorBarListener();//Add颜色选择处理
            me._addBrushBarListener();//Add画笔大小处理
            me._addEraserBarListener();//Add橡皮大小处理
            me._addAddImgListener();//Add增添背景图片处理
            me._addRemoveImgListenter();//Delete背景图片处理
            me._addScalePicListenter();//Add缩放处理
            me._addClearSelectionListenter();//Add清楚选中状态处理
