...
(function(){
    ...
    /**
     * 监听确认和取消两个按钮事件，User 执行插入或者清空正在播放的视频实例Operation
     */
    ...
    /**
     * 找到id下具有focus类的节点并Return该节点下的某个属性
     * @param id
